...
let template;
const data = {
  message: "It's running! Testing stream - why does it work like this"
};
...
app.get('/', async (req, res) => {
  ...
  if (!template) {
    ...
    try {
      template = handlebars.compile(readFileSync(path.join(__dirname, 'index.html'), 'utf8'));
    } catch (e) {
      console.error(e);
